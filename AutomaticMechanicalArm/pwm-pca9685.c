...
#define PCA9685_PRESCALE_MIN	0x03	/* => min. frequency of 1526 Hz */
#define PCA9685_PRESCALE_MAX	0xFF	/* => max. frequency of 24 Hz */
				...
				const struct i2c_device_id *id)
{
	...
	if (IS_ERR(pca->regmap)) {
		...
		dev_err(&client->dev, "Failed to initialize register map: %d\n",
			ret);
		printk("!@!@!@!@pca9685_pwm_probe Failed to initialize register map: %d\n\n",ret);
		return ret;
	}
	pca->duty_ns = 0;
